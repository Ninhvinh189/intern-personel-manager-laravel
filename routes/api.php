...
//    });
    ...
    Route::group(["prefix" => "/user"],function ()
    {
        ...
        Route::post("/create-user",[\App\Http\Controllers\UserController::class,'createUser'])->middleware('admin');
        Route::post("/update-user/{user}",[\App\Http\Controllers\UserController::class,'updateUser']);
        Route::post("/update-profile/{user}",[\App\Http\Controllers\UserController::class,'updateProfile']);
        ...
        Route::get('/list-user-department/{user}',[\App\Http\Controllers\UserController::class,'getListUserDepartment']);
    });
...
//            Route::get('/roles',[\App\Http\Controllers\RoleController::class,'index']);
    ...
    Route::get('role/roles',[\App\Http\Controllers\RoleController::class,'index']);
